...
sidebar: sidebar 
keywords:  
summary: Sie können ein Upgrade der virtuellen Unified Manager Appliance von Version 9.7 und 9.8 auf Version 9.9 durchführen. 
---
...
[role="lead"]
Sie können ein Upgrade der virtuellen Unified Manager Appliance von Version 9.7 und 9.8 auf Version 9.9 durchführen.
